...
//                         'lib/assets/880309d8d37dba8d3a87672e52a35231ec7c6673.png'), // Replace with your asset or network image
//                   ),
//                 ),
//               ),
...
//                        GestureDetector(
//             onTap: () {
//                   Navigator.push(context, MaterialPageRoute(builder: (context)=>AppliedJobsScreen()));
//             },
...
//              GestureDetector(
//             onTap: () {
//                   Navigator.push(context, MaterialPageRoute(builder: (context)=>ListInvoiceScreen()));
//             },
...
//              Divider(),
//           const SizedBox(height: 16),
//           _buildTile(Icons.privacy_tip, 'Privacy Policy', iconColor: Colors.orange),
//             Divider(),
//           _buildTile(Icons.info_outline, 'About Us', iconColor: Colors.lightBlue),
//             Divider(),
//           _buildTile(Icons.help_outline, 'Help', iconColor: Colors.cyan),
//             Divider(),
//           _buildTile(Icons.power_settings_new, 'Logout', iconColor: Colors.deepPurple),
//             Divider(),
//         ],
//       ),
//     );
...
//   Widget _buildTile(IconData icon, String title, {Color iconColor = Colors.blue}) {
//     return ListTile(
...
//               Navigator.push(
//                 context,
//                 MaterialPageRoute(builder: (context) => ListInvoiceScreen()),
//               );
//             },
//             child: _buildTile(Icons.inventory_outlined, 'Get Invoice'),
//           ),
